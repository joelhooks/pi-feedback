...
This repo treats dependency, workflow, extension, and skill changes as security-sensitive.
...
- Require review for `.github/workflows/`, `.github/actions/`, package manifests, lockfiles, `.npmrc`, extension code, and skills.
